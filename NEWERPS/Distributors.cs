    ...
    public partial class Distributors : Form
    {
        ...
        private void CheckID()
        {
            try
            {
                ...
                string sql = string.Format("select count(Distributors_ID) as count from Distributors where Distributors_ID = '{0}'", tb代號.Text);
        ...
        private void InsertData()
        {
            try
            {
                ...
                string sql1 = string.Format("insert into Distributors values ('{0}','{1}','{2}','{3}','{4}','{5}',GETDATE())", tb代號.Text, tb中文.Text, tb英文.Text, tb備註.Text, tb備註1.Text, userid);
        ...
        private void ModifyData()
        {
            try
            {
                ...
                sql4.AppendFormat("update Distributors set zwsm = '{0}', ywsm = '{1}', BZ = '{2}', BZ1 = '{3}', USERID = '{4}', USERDATE = GETDATE() where DESTINATION_ID = '{5}'", tb中文.Text, tb英文.Text, tb備註.Text, tb備註1.Text, userid, tb代號.Text);
        ...
        private void Reload()
        {
            ds = new DataSet();
            DBconnect dbConn = new DBconnect();
            string sql = string.Format("select * from Distributors");
        ...
        private void tsbQuery_Click(object sender, EventArgs e)
        {
            try
            {
                DistributorsQuery Form = new DistributorsQuery();
                Form.ShowDialog();

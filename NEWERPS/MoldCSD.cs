...
{
    /// <summary>
    /// MoldClassSetDetail 工制具類別設定速查
    /// </summary>
    public partial class MoldCSD : Form
    {
        #region 變數

        public string 工具類別, 中文, 英文, 部位分類;
        private int cbindex;
        ...
        private void MoldClassSetDetail_Load(object sender, EventArgs e)
        {
        ...
        private void chkALL_CheckedChanged(object sender, EventArgs e)
        {
            if (chkALL.Checked)
            {
                cbindex = cbMoldPart.SelectedIndex;
            ...
            else
            {
                ...
                cbMoldPart.SelectedIndex = cbindex;
            }
        } 
        ...
        {
            isq = true;
            工具類別 = this.tbMoldClass.Text;
            中文 = this.tbMoldNameCN.Text;
            英文 = this.tbMoldNameEN.Text;
            this.Close();
        }

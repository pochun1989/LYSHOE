    ...
    public partial class Country : Form
    {
        ...
        private void CheckID()
        {
            try
            {
                //ds2 = new DataSet();
                DBconnect dbConn = new DBconnect();
                string sql = string.Format("select count(COUNTRY_ID) as count from COUNTRY where COUNTRY_ID = '{0}'", tb代號.Text);
        ...
        private void InsertData()
        {
            try
            {
                ...
                string sql1 = string.Format("insert into COUNTRY values('{0}','{1}','{2}','{3}',GETDATE())", tb代號.Text, tb中文.Text, tb英文.Text, userid);
        ...
        private void ModifyData()
        {
            try
            {
                ...
                sql4.AppendFormat("update COUNTRY set zwsm = '{0}', ywsm = '{1}', USERID = '{2}', USERDATE = GETDATE() where COUNTRY_ID = '{3}'", tb中文.Text, tb英文.Text, userid, tb代號.Text);
        ...
        private void tsbQuery_Click(object sender, EventArgs e)
        {
            try
            {
                CountryQuery Form = new CountryQuery();
                Form.ShowDialog();
        ...
        private void P0002_Click(object sender, EventArgs e)
        {

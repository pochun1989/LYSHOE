...
namespace NEWERPS
{
    public partial class PaymentTerm : Form
    {
        public PaymentTerm()
        {
            InitializeComponent();
        ...
        private void CheckID()
        {
            try
            {
                ...
                string sql = string.Format("select count(PAYEMNT_TERM_ID) as count from PAYEMNT_TERM where PAYEMNT_TERM_ID = '{0}'", tb代號.Text);
        ...
        private void InsertData()
        {
            try
            {
                ...
                string sql1 = string.Format("insert into PAYEMNT_TERM values('{0}','{1}','{2}','{3}',GETDATE())", tb代號.Text, tb中文.Text, tb英文.Text, userid);
        ...
        private void ModifyData()
        {
            try
            {
                ...
                sql4.AppendFormat("update PAYEMNT_TERM set zwsm = '{0}', ywsm = '{1}', USERID = '{2}', USERDATE = GETDATE() where PAYEMNT_TERM_ID = '{3}'", tb中文.Text, tb英文.Text, userid, tb代號.Text);
        ...
        private void tsbQuery_Click(object sender, EventArgs e)
        {
            try
            {
                PaymentTermQuery Form = new PaymentTermQuery();
                Form.ShowDialog();
